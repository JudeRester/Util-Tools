...
CALENDAR_CONFIG_EXAMPLE_PATH = os.path.join(BUNDLE_DIR, "calendar_config.example.json")
APP_SETTINGS_PATH = os.path.join(APP_DIR, "app_settings.json")
APP_SETTINGS_EXAMPLE_PATH = os.path.join(BUNDLE_DIR, "app_settings.example.json")
